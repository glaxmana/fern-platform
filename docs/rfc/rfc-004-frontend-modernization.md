...
**Where:** `migrations/000022_v2_schema.{up,down}.sql`; `scripts/v2-preflight-indexes.sh` for non-blocking deploys on large databases; `docs/specs/frontend-modernization/migration-guide.md` §4 for operator-facing rollout and recovery procedures.
